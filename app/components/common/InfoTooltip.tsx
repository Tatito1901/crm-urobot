  ...
  return (
    <Tooltip delayDuration={delayDuration}>
      <TooltipTrigger asChild>
        {children || (
          <span className="inline-flex items-center justify-center w-4 h-4 rounded-full bg-teal-500/20 text-teal-300 text-[10px] font-bold cursor-help hover:bg-teal-500/30 transition-colors">
            ?
          </span>
        )}
      </TooltipTrigger>
