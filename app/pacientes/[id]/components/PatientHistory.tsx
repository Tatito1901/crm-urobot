      ...
      <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="space-y-4">
            {sortedConsultas.length === 0 ? (
              ...
              sortedConsultas.map((consulta) => (
                <div
                  key={consulta.id}
                  className="bg-slate-900/60 border border-slate-700/50 rounded-lg p-4 hover:border-slate-600/50 transition-all"
                >
                  {/* Header de la cita */}
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-slate-800/60 hover:bg-slate-700/60 border border-slate-700/50 rounded-lg text-sm text-slate-300 transition-colors"
                        >
                        ...
                        <button
                          onClick={() => onVerEpisodio?.(consulta.id)}
                          className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-blue-500/10 hover:bg-blue-500/20 border border-blue-500/30 rounded-lg text-sm text-blue-400 transition-colors"
                        >
                  ...
                  {consulta.motivoConsulta && (
                    <div className="mt-3 pt-3 border-t border-slate-800/50">
                      ...
                      <p className="text-sm text-slate-300">{consulta.motivoConsulta}</p>
                    </div>
                  )}
        ...
        {activeTab === 'episodios' && (
          <div className="text-center py-12">
            ...
            <p className="text-slate-400">No hay episodios clínicos registrados</p>
        ...
        {activeTab === 'documentos' && (
          <div className="text-center py-12">
            <FileDown className="h-16 w-16 text-slate-600 mx-auto mb-4" />
        ...
        {activeTab === 'datos' && (
          <div className="space-y-4">
            <div className="bg-slate-900/60 border border-slate-700/50 rounded-lg p-4">
              <h3 className="text-sm font-semibold text-white mb-4">Información del paciente</h3>
