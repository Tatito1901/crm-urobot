...
export function SidebarChatViewer({ telefono, nombreDisplay }: SidebarChatViewerProps) {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="shrink-0 px-3 py-2 bg-secondary/30 border-b border-border flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          <a
            ...
            className="flex items-center gap-1 px-2 py-1 bg-emerald-500/10 text-emerald-400 text-[10px] font-medium rounded-md hover:bg-emerald-500/20 transition-colors"
          >
      ...
      {/* Chat messages */}
      <div className="flex-1 overflow-y-auto px-2.5 py-3 space-y-4 scroll-smooth overscroll-contain bg-slate-950/30">
          ...
          {msg.mediaUrl && msg.tipoMensaje !== 'text' && (
            <div className="px-2.5 pt-2 pb-0.5">
              <span className={`inline-flex items-center gap-1 text-[10px] font-medium px-1.5 py-0.5 rounded ${
                isBot ? 'bg-slate-700 text-muted-foreground' : 'bg-white/20 text-white/80'
              }`}>
