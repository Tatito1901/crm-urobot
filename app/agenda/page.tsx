  ...
  return (
    <div className="h-full flex flex-col bg-background">
      ...
      <button
        ...
        className="lg:hidden fixed bottom-[calc(5rem+env(safe-area-inset-bottom,0px))] right-4 z-50 w-14 h-14 bg-blue-500 hover:bg-blue-600 text-white rounded-full shadow-2xl flex items-center justify-center transition-all active:scale-95"
