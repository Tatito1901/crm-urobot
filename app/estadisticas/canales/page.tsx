...
const RechartsPieChart = dynamic(
  ...
  { 
    loading: () => <div className="h-[500px] w-full bg-muted/20 rounded-lg animate-pulse flex items-center justify-center"><div className="w-40 h-40 rounded-full bg-muted" /></div>,
    ssr: false 
  }
);
