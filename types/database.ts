...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      check_numero_bloqueado: { Args: { p_telefono: string }; Returns: Json }
      check_rate_limit: {
        Args: { p_telefono: string }
        Returns: {
          mensajes_en_ventana: number
      ...
      get_clinical_insights: { Args: never; Returns: Json }
      get_consultas_stats: { Args: never; Returns: Json }
      get_conversaciones_stats: { Args: { p_dias?: number }; Returns: Json }
      get_conversation_funnel_stats: {
        Args: { p_dias?: number }
        Returns: Json
      }
      get_dashboard_stats_fast: { Args: never; Returns: Json }
      get_dashboard_v3: { Args: never; Returns: Json }
      get_impact_stats: { Args: never; Returns: Json }
      get_leads_by_campaign_stats: { Args: { p_dias?: number }; Returns: Json }
      get_leads_stats_optimized: { Args: never; Returns: Json }
      get_mensajes_por_telefono: {
        Args: { p_limit?: number; p_telefono: string }
        Returns: Json
      }
      get_pacientes_with_stats: { Args: never; Returns: Json }
      get_urobot_metricas_crm: { Args: { p_dias?: number }; Returns: Json }
      ...
      guardar_mensaje_urobot:
        ...
        | {
            Args: {
              p_accion_bot: string
              p_contenido: string
              p_espera_respuesta?: boolean
              p_fase_conversacion: string
              p_latencia_ms: number
              p_mensaje_id_externo: string
              p_metadata: Json
              p_modelo_ia: string
      ...
      puede_enviar_mensaje_whatsapp: {
        Args: {
          p_max_por_dia?: number
          p_max_por_hora?: number
          p_max_por_minuto?: number
          p_telefono: string
        }
        Returns: Json
      }
      ...
      upsert_lead_v12: {
        ...
        Returns: {
          ...
          out_funnel: string
          out_intencion_agendar: number
          out_lead_id: string
          out_necesidad_clinica: number
          out_perfil_paciente: number
      ...
      validate_lead_transition: {
        Args: { p_from: string; p_to: string; p_triggered_by?: string }
        Returns: boolean
      }
    }
    Enums: {
